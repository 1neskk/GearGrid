    ...
    <div class="page">
        <main class="bg-gradient-to-b from-purple-600 to-bg-slate-950">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-8">
                <input v-model="mouse.name" type="text" placeholder="Name" class="p-2 text-black border border-gray-300 rounded-lg" />
                <input v-model="mouse.price" type="text" placeholder="Price" class="p-2 text-black border border-gray-300 rounded-lg" />
